...
void Api::Apps::Timelogger::getStatus(
    const drogon::HttpRequestPtr &,
    std::function<void(const drogon::HttpResponsePtr &)> &&callback,
    int64_t pSubid) {
  // first we fetch the timelog name
  drogon::app().getDbClient()->execSqlAsync(
      "SELECT name FROM timelog WHERE id=$1",
      [callback = std::move(callback),
       pSubid](const drogon::orm::Result &r) mutable {
        if (r.size() == 1) {
          Json::Value resp;
          ...
          // then the activities
          drogon::app().getDbClient()->execSqlAsync(
              "SELECT * FROM timelog_activity WHERE timelogid=$1",
              [callback = std::move(callback), resp = std::move(resp),
               pSubid](const drogon::orm::Result &r) mutable {
                ...
                drogon::app().getDbClient()->execSqlAsync(
                    ...
                    [callback = std::move(callback), resp = std::move(resp)](
                      ...
                      if (r.size() == 0 || !r.at(0)["duration"].isNull()) {
                        ...
                        currentActivity["id"] =
                            r.at(0)["activityid"].as<int64_t>();
                        currentActivity["created"] =
                            r.at(0)["created"].as<int64_t>();
...
void Api::Apps::Timelogger::createActivity(
    const drogon::HttpRequestPtr &,
    std::function<void(const drogon::HttpResponsePtr &)> &&callback,
    int64_t pTimelogId, std::string &&pActivityName) {
  drogon::app().getDbClient()->execSqlAsync(
      "INSERT INTO timelog_activity (timelogid, name) VALUES ($1, $2)",
...
static void isActivityRunning(
    int64_t pTimelogId, std::function<void(bool)> &&pCallback,
    std::function<void(const drogon::HttpResponsePtr &)> errReceiver) {
  drogon::app().getDbClient()->execSqlAsync(
      "SELECT * FROM timelog_entry WHERE timelogid = $1 ORDER BY created DESC "
      "LIMIT 1",
...
void Api::Apps::Timelogger::startActivity(
    const drogon::HttpRequestPtr &,
    std::function<void(const drogon::HttpResponsePtr &)> &&callback,
    int64_t pTimelogId, int64_t pActivityId) {
  isActivityRunning(
      pTimelogId,
      [callback = std::move(callback), pTimelogId,
       pActivityId](bool pRunning) mutable {
        if (pRunning) {
          callback(genError("Activity is already running!"));
        } else {
          drogon::app().getDbClient()->execSqlAsync(
              "INSERT INTO timelog_entry (timelogid, activityid, created) "
              "VALUES ($1, $2, current_timestamp)",
              [callback =
                   std::move(callback)](const drogon::orm::Result &r) mutable {
                callback(genResponse("ok"));
              },
...
void Api::Apps::Timelogger::stopActivity(
    const drogon::HttpRequestPtr &,
    std::function<void(const drogon::HttpResponsePtr &)> &&callback,
    int64_t pTimelogId) {
  drogon::app().getDbClient()->execSqlAsync(
      ...
      "LIMIT 1",
      [callback = std::move(callback),
       pTimelogId](const drogon::orm::Result &r) mutable {
...
void Api::Apps::Timelogger::deleteActivity(
    const drogon::HttpRequestPtr &req,
    std::function<void(const drogon::HttpResponsePtr &)> &&callback,
    int64_t pTimelogId, int64_t pActivityId) {
  drogon::app().getDbClient()->execSqlAsync(
      "DELETE FROM timelog_activity WHERE timelogid=$1 AND id=$2",
      [callback = std::move(callback),
       pTimelogId](const drogon::orm::Result &r) mutable {
        callback(genResponse("ok"));
      },
...
void Api::Apps::Timelogger::abortActivity(
    const drogon::HttpRequestPtr &req,
    std::function<void(const drogon::HttpResponsePtr &)> &&callback,
    int64_t pTimelogId) {
  drogon::app().getDbClient()->execSqlAsync(
      ...
      [callback = std::move(callback),
       pTimelogId](const drogon::orm::Result &r) mutable {
        ...
        drogon::app().getDbClient()->execSqlAsync(
            R"(DELETE FROM timelog_entry WHERE id=$1)",
            [callback =
                 std::move(callback)](const drogon::orm::Result &r) mutable {
              callback(genResponse("ok"));
            },
